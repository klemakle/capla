<template>
 <div class="flex flex-col py-4 mx-4 px-4 my-14 justify-between items-center">
      ...
      <div class="flex flex-col justify-between items-start mt-8">
        ...
        <div class="text-indigo-400 my-2 text-lg md:text-xl">Cours du weekend : <span class="text-gray-400 text-sm md:text-xl">Samedi </span> <span class="text-gray-400 text-sm md:text-xl"> 17h-20h</span></div>
        <div class="text-indigo-400 my-2 text-lg md:text-xl">Cours en ligne : <span class="text-gray-400 text-sm md:text-xl">2 séances par semaine </span></div>
      </div>
