...
<div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
  <div class="max-w-lg mx-auto">
    ...
    <p v-if="messageError" class="max-w-md mx-auto mt-4 text-center text-red-400 border-2 border-red-100  rounded-md bg-red-50">
      {{messageError}}
    </p>

    <p v-if="messageSucces" class="max-w-md mx-auto mt-4 text-center text-green-600 border-2 border-green-200  rounded-md bg-green-50">
       {{messageSucces}}
    </p>
    ...
    <div action="" class="p-8 mt-6 mb-0 space-y-4 rounded-lg shadow-2xl">
      ...
      <button type="submit" @click="createSession" class="block w-full px-5 py-3 text-sm font-medium text-white bg-indigo-600 rounded-lg">
        Valider
      </button>
